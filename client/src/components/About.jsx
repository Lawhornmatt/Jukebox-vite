...
const About = () => {
    ...
    return(
        <Box   verticalAlign="center">
            <Heading paddingY = '150px'  as='h1' size='4xl' noOfLines={1} fontFamily='-moz-initial' background={colorTitle} fontSize={{ base: '5xl', sm: '6xl', md: '7xl' }}  borderRadius="15px" justifyContent="center">
        Welcome to Jukebox!
